...
git push`;
  ...
  return (
    <div className="p-4 h-full flex flex-col">
      <h3 className="text-lg font-semibold text-white mb-4 sticky top-0 bg-gray-900 py-2">Actions</h3>
      ...
      <div className="bg-gray-800 border border-gray-700 p-4 rounded-lg mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <button
            ...
            className="p-1.5 bg-gray-700 hover:bg-blue-500/50 rounded-md transition-colors"
        ...
        <p className="text-sm bg-gray-900 p-2 rounded-md font-mono text-gray-300">
          {commitMessage}
        </p>
      </div>
      ...
      <div className="bg-gray-800 border border-gray-700 p-4 rounded-lg">
        ...
        <div className="bg-gray-950 p-3 rounded-md font-mono text-sm text-gray-300 relative">
          <pre className="whitespace-pre-wrap">{gitCommands}</pre>
          <button
            onClick={handleCopyCommands}
            className="absolute top-2 right-2 p-1.5 bg-gray-700 hover:bg-blue-500/50 rounded-md transition-colors"
